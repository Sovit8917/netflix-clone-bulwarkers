  ...
  return (
    <div className="absolute top-0 left-0 w-full z-50 flex items-center justify-between px-4 sm:px-10 lg:px-[148px] py-[24px] bg-gradient-to-b from-black/100 to-black/0">
      <svg
        ...
        aria-label="Netflix"
        role="img"
        className="fill-logo h-[28px] sm:h-[36px] lg:h-[40px] w-auto transition-colors duration-300"
      >
        <g>
      ...
      <div className="flex items-center pr-[4px] gap-2 sm:gap-3">
        ...
        <button className="bg-accent hover:bg-accent-hover text-btn text-sm font-semibold px-[12px] sm:px-[15px] py-[6px] rounded transition-all duration-300">
          Sign In
        </button>
      </div>
    </div>
